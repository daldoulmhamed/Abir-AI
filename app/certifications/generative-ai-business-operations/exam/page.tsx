...
const CERTIFICATION_ID = "generative-ai-business-operations";

const VALIDATES = [
  "Ability to identify high-value AI use cases in operations",
  "Process optimization and workflow automation with AI",
  "ROI estimation and business-case building",
  "Risk management, governance, and responsible AI adoption",
  "Change management and stakeholder communication"
];

const AUDIENCE = [
  "Operations and business leaders applying AI",
  "Managers standardizing AI-driven processes",
  "Consultants and transformation teams",
  "Learners who completed the free business operations modules"
];
...
const TRUST_POINTS = [
  ...
  "No trick questions—focus is on operational impact"
];
...
async function validateRetakeCode(code: string): Promise<boolean> {
  ...
  return Boolean(code && code.trim().length >= 6 && code.trim().startsWith("OPS-"));
}
  ...
  return (
    <main className="bg-slate-50 text-slate-900 dark:bg-slate-950 dark:text-white">
      ...
      <section className="relative overflow-hidden border-b border-slate-200/70 dark:border-slate-800">
        <div className="absolute inset-0 bg-gradient-to-br from-emerald-600/15 via-teal-500/10 to-transparent" />
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
          <div className="flex items-center gap-2 text-sm text-slate-500 dark:text-slate-400">
            ...
            <span>/</span>
            <Link
              href="/certifications/generative-ai-business-operations"
          ...
          <div className="mt-8 grid lg:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <p className="mt-5 text-lg text-slate-600 dark:text-slate-300">
                Validate real-world operational AI skills with a focused, fair assessment built for business impact. Learning content is free; the exam is a paid credential.
              </p>
        ...
        <div className="grid lg:grid-cols-2 gap-10">
          <div>
            ...
            <p className="mt-3 text-slate-600 dark:text-slate-300">
              This assessment verifies operational decision-making and AI strategy implementation, not memorization.
            </p>
          ...
          <div className="w-full max-w-md rounded-xl bg-white dark:bg-slate-900 p-6 shadow-xl">
            <div className="flex items-start justify-between">
              <div>
                ...
                <p className="mt-1 text-sm text-slate-600 dark:text-slate-300">
                  Voucher codes unlock paid exam access. Example: OPS-XXXXXX
                </p>
              </div>
              <button
          ...
          <div className="w-full max-w-md rounded-xl bg-white dark:bg-slate-900 p-6 shadow-xl">
            <div className="flex items-start justify-between">
              <div>
                ...
                <p className="mt-1 text-sm text-slate-600 dark:text-slate-300">
                  Retake codes unlock your extra attempt after a paid exam. Example: OPS-XXXXXX
                </p>
              </div>
              <button

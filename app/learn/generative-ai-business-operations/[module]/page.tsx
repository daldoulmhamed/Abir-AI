...
const modules = [
  { id: 'module-1', slug: 'module-1', title: 'AI Strategy & Planning', file: 'module-1-ai-strategy-planning.md' },
  { id: 'module-2', slug: 'module-2', title: 'Process Optimization with AI', file: 'module-2-process-optimization-with-ai.md' },
  { id: 'module-3', slug: 'module-3', title: 'ROI & Business Case Development', file: 'module-3-roi-business-case-development.md' },
  { id: 'module-4', slug: 'module-4', title: 'AI-Driven Decision Making', file: 'module-4-ai-driven-decision-making.md' },
  { id: 'module-5', slug: 'module-5', title: 'Risk Management', file: 'module-5-risk-management.md' },
  { id: 'module-6', slug: 'module-6', title: 'Change Management & Adoption', file: 'module-6-change-management-adoption.md' }
];
      ...
      <div className="pt-32 pb-16 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mt-8 flex items-center justify-between gap-4">
            {prevModule ? (
              <Link
                href={`/learn/generative-ai-business-operations/${prevModule.slug}`}
            ...
            {nextModule ? (
              <Link
                href={`/learn/generative-ai-business-operations/${nextModule.slug}`}
                className="flex items-center gap-2 bg-gradient-to-r from-blue-600 to-cyan-600 text-white px-6 py-3 rounded-xl shadow-lg hover:shadow-xl transition-all hover:scale-105"
              >
